...
import ifandikaImg from "../assets/HD_M.Ifandika_Fix Profile.png";
import logoTKM from "../assets/img_logo_tkm.png";
import logoUMPWR from "../assets/img_logo_umpwr.png";

/**
 * Fungsi ini mengembalikan halaman Home atau tampilan utama
 * @returns
 */
        ...
        <Container sx={{ marginTop: "60px" }}>
          ...
          <Box sx={{ flexGrow: 2 }}>
            <Grid container {...(isMobileLayout ? { columns: true } : {})}>
              ...
              >
                ...
                <TypeAnimation
                  sequence={[
                    "Welcome to my personal website. I love science, technology, and mathematics, especially in the field of software development. I prefer systems or back-end work, especially those related to logic. Some of my interests include Software Development (Mobile, Web), IoT, Artificial Intelligence, Linux, Computer Networks, Graphic Design, Video Editing, and more. I'm open to new things and always want to improve and be useful.",
                  ]}
                  wrapper="span"
                  speed={70}
                  style={{
            ...
            <Box sx={{ flexGrow: 2 }}>
              <Grid container spacing={2}>
                ...
                >
                  <img
                    src={logoUMPWR}
                    alt="Logo Universitas Muhammadiyah Purworejo"
                    style={{
                      ...logoEducationStyle,
                      objectFit: "contain", // Agar gambar proporsional
                    }}
                  />
                </Grid>
                <Grid size={{ xs: 12, md: 10 }}>
                  ...
                  <h4>
                    ...
                    <br />
                    2024 - Present <br />
                    Activities and societies: Computer Science, Software
                    Engineer <br />
                  </h4>
                </Grid>
              </Grid>
              ...
              <Grid container spacing={2}>
                ...
                >
                  <img
                    src={logoTKM}
                    alt="Logo SMK TKM Teknik Purworejo"
                    style={{
                      ...logoEducationStyle,
                      objectFit: "contain",
                    }}
                ...
                <Grid size={{ xs: 12, md: 10 }}>
                  <h2>SMK TKM Teknik Purworejo</h2>
                  <h4>
          ...
          <Box sx={{ flexGrow: 2 }}>
            ...
            >
              ...
              >
                <a
                  href="https://www.youtube.com/@be.expertz"
                  style={{ textDecoration: "none", color: "white" }}
                >
              ...
              >
                <a
                  href="https://www.linkedin.com/in/maulana-ifandika/"
                  style={{ textDecoration: "none", color: "white" }}
                >
              ...
              >
                <a
                  href="https://www.threads.com/@ifandika.m"
                  style={{ textDecoration: "none", color: "white" }}
                >
                  <svg
              ...
              >
                <a
                  href="https://medium.com/@ifandika"
                  style={{ textDecoration: "none", color: "white" }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <a
                  href="https://discord.com/users/ifandika"
                  style={{ textDecoration: "none", color: "white" }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <a
                  href="https://stackoverflow.com/users/21181594/maulana-ifandika"
                  style={{ textDecoration: "none", color: "white" }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <a
                  href="https://leetcode.com/u/Ifandika/"
                  style={{ textDecoration: "none", color: "white" }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <a
                  href="https://www.hackerrank.com/profile/Ifandika"
                  style={{ textDecoration: "none", color: "white" }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    <path
                      ...
                      className="svgShape color2fc363-0 selectable"
                    ></path>
                  </svg>
                </a>
              </Grid>
              ...
              >
                <a
                  href="https://codeforces.com/profile/Ifandika"
                  style={{ textDecoration: "none", color: "white" }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
